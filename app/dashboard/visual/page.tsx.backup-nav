  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {slots.map((slot) => (
                  <div
                    ...
                    style={{
                      padding: '12px',
                      backgroundColor: editingSlot?.id === slot.id ? '#e7f3ff' : 'white',
                      border: editingSlot?.id === slot.id ? '2px solid #007bff' : '1px solid #dee2e6',
                      borderRadius: '4px',
                      cursor: 'pointer',
                      transition: 'all 0.2s',
                      boxShadow: editingSlot?.id === slot.id ? '0 2px 8px rgba(0,123,255,0.2)' : 'none'
                    }}
                    onMouseEnter={(e) => {
        ...
        <div style={{
          flex: editingSlot ? '0 0 calc(100% - 280px - 420px)' : '1',
