      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{
            ...
            Edit specific zones on your site. Watch changes happen live.
          </p>
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li>Change the hero headline to Welcome to AI-Powered Marketing</li>
            <li>Update the CTA button to Start Your Free Trial</li>
            <li>Change the homepage title to Transform Your Business Today</li>
          </ul>
        </div>
        ...
        <div style={{ marginBottom: '12px' }}>
          ...
          <textarea
            ...
            placeholder="e.g., Change the hero headline to [your new headline]..."
            disabled={processing}
            style={{
              width: '100%',
              minHeight: '100px',
        ...
        <div style={{
          ...
          <strong>Zone-Based Editing:</strong> Target specific slots like "hero headline", "CTA button", or "homepage title". The system finds and updates only that zone - keeping your site structure safe.
        </div>
      </div>
